...
class Dish(models.Model):
    ...
    image = CloudinaryField('images/',default='ttgaogawdwdfmexebiwz.jpg',blank=True,null=False)
    basic = models.TextField(max_length=200, default='없음', blank = True, null=True) #기본재료 중에서 필요한 것
