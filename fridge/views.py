...
def showdish(request):
    allingre = ['밥', '식빵', '달걀', '김치', '햄', 
        '라면', '소면', '파스타면', '칼국수 면', '두부면',
        '김', '바지락', '낙지', '오징어', '쭈꾸미', '게맛살',
        '닭고기', '닭가슴살', '돼지고기', '삼겹살', '돼지목살', '소고기', '차돌박이',
        '버섯', '파', '양파', '샐러드야채', '시금치', '숙주나물', '콩나물', '당근', '감자', '고구마', '애호박', '고추', '깻잎', '청경채',
        '고추장', '고춧가루', '우유', '잼', '토마토소스', '까르보나라소스', '생크림', '굴소스', '치킨스톡', '통마늘', '다진마늘', '맛술', '불닭소스', '마요네즈', '케찹', '버터',
        '블루베리', '딸기', '바나나', '귤', '사과', '그래놀라', '시리얼', '딸기청', '자몽청', '플레인요거트', '그릭요거트'
        ]
